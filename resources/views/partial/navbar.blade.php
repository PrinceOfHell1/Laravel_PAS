<nav class="navbar navbar-expand-lg bg-dark sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand text-light" href="/about">Hospital</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-link text-light" href="/dokter/all">Doctor</a>
        ...
        <ul class="nav-pills navbar-nav ms-auto">
            @auth
                <li class="nav-link dropdown">
                    <a style="background-color: #34C6DA;" class="text-light nav-link dropdown-toggle" href="#" role="button"
            ...
            @else
                <li class="nav-item">
                    <a style="background-color: #34C6DA;" href="/session/login/all" class="text-light nav-link bi bi-box-arrow-right">Login</a>
                </li>
            @endauth
        </ul>
