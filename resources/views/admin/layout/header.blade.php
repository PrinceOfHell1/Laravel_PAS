<header style="background-color: #34C6DA;" class="navbar navbar-dark sticky-top flex-md-nowrap p-0 shadow ">
    <a style="text-decoration: none; color: white;" class="col-md-3 col-lg-2 me-0 px-3 fs-5" href="/admin/all">Data Admin</a>
    ...
    <div class="navbar-nav">
        <div class="nav-item text-nowrap">
            <a class="nav-link px-3 text-light" href="/session/logout">Sign out</a>
        </div>
    </div>
