            ...
            <div class="col-ad-12">
                ...
                <div class="">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-2">
                                <a style="font-size: 13px; background-color: #34C6DA; color: white;" type="button" class="btn href="create">Tambah Data Baru</a>
                            </div>
                            <div class="col-md-10">
                                <form action="/admin/dokter/all" method="GET" role="search">
                                    <div class="row mb-4">
                                        <div class="col-md-2">
                                            <select style="font-size: 13px;" name="dokter_id" id="dokter_id" class="form-select">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group mb-3">
                                                <input style="font-size: 13px;" type="text" name="search" class="form-control"
                                                    placeholder="Search name.." aria-label="Search username"
                                                    aria-describedby="basic-addon2" value="{{ request('search') }}">
                                                <button style="background-color: #34C6DA; color: white;" class="btn" id="search"
